...
assignin(mdlWorkspace, 'Left_EO', 0);
assignin(mdlWorkspace, 'Left_IO', 0);
assignin(mdlWorkspace, 'Left_LongThor', 0);
assignin(mdlWorkspace, 'Left_MF', 0);
assignin(mdlWorkspace, 'Left_Psoas', 0);
assignin(mdlWorkspace, 'Left_RA', 0);

assignin(mdlWorkspace, 'Right_EO', 0);
assignin(mdlWorkspace, 'Right_IO', 0);
assignin(mdlWorkspace, 'Right_LongThor', 0);
assignin(mdlWorkspace, 'Right_MF', 0);
assignin(mdlWorkspace, 'Right_Psoas', 0);
...
% Display results
fprintf('C4 Compile Time: Avg = %.2f sec, SD = %.2f sec\n', avgCompileTime, stdCompileTime);
fprintf('C4 Run Time: Avg = %.2f sec, SD = %.2f sec\n', avgRunTime, stdRunTime);
