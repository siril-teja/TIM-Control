...
MODEL                = draft7
MODULES              = draft7_a151ee3d_1.c draft7_a151ee3d_1_create.c draft7_a151ee3d_1_setParameters.c draft7_a151ee3d_1_asserts.c draft7_a151ee3d_1_deriv.c draft7_a151ee3d_1_checkDynamics.c draft7_a151ee3d_1_compOutputsKin.c draft7_a151ee3d_1_compOutputsDyn.c draft7_a151ee3d_1_asm_delegate.c draft7_a151ee3d_1_sim_delegate.c draft7_a151ee3d_1_mode_zero_crossings.c draft7_a151ee3d_1_logging.c draft7_a151ee3d_1_geometries.c draft7_a151ee3d_1_gateway.c rt_backsubrr_dbl.c rt_forwardsubrr_dbl.c rt_lu_real.c rt_matrixlib_dbl.c draft7.c draft7_capi.c draft7_data.c draft7_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c raccel_main.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c
PRODUCT              = draft7.exe
MAKEFILE             = draft7.mk
MATLAB_ROOT          = D:/Matlab R2023a
ALT_MATLAB_ROOT      = D:/Matlab R2023a
...
MODELLIB                  = 
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = draft7_ref.rsp
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/raccel/draft7 \
	...
	-I$(MATLAB_ROOT)/extern/physmod/win64/pm_math/include \
	-I$(MATLAB_ROOT)/extern/physmod/win64/sm/include \
	-I$(MATLAB_ROOT)/extern/physmod/win64/sm_ssci/include \
...
ifeq ($(INTEGER_CODE),0)
ifeq ($(MODELREF_TARGET_TYPE),SIM)
LIBS += $(MATLAB_ROOT)/extern/physmod/win64/sm_ssci/lib\sm_ssci_rtwsfcn_lcc.lib
else
LIBS += $(MATLAB_ROOT)/extern/physmod/win64/sm_ssci/lib\sm_ssci_ert_lcc.lib
endif
else
LIBS += $(MATLAB_ROOT)/extern/physmod/win64/sm_ssci/lib\sm_ssci_int_ert_lcc.lib
endif
else
LIBS += sm_ssci.lib
endif
...
ifeq ($(INTEGER_CODE),0)
ifeq ($(MODELREF_TARGET_TYPE),SIM)
LIBS += $(MATLAB_ROOT)/extern/physmod/win64/sm/lib\sm_rtwsfcn_lcc.lib
else
LIBS += $(MATLAB_ROOT)/extern/physmod/win64/sm/lib\sm_ert_lcc.lib
endif
else
LIBS += $(MATLAB_ROOT)/extern/physmod/win64/sm/lib\sm_int_ert_lcc.lib
endif
else
LIBS += sm.lib
endif
...
ifeq ($(INTEGER_CODE),0)
ifeq ($(MODELREF_TARGET_TYPE),SIM)
LIBS += $(MATLAB_ROOT)/extern/physmod/win64/pm_math/lib\pm_math_rtwsfcn_lcc.lib
else
LIBS += $(MATLAB_ROOT)/extern/physmod/win64/pm_math/lib\pm_math_ert_lcc.lib
endif
else
LIBS += $(MATLAB_ROOT)/extern/physmod/win64/pm_math/lib\pm_math_int_ert_lcc.lib
endif
else
LIBS += pm_math.lib
endif
