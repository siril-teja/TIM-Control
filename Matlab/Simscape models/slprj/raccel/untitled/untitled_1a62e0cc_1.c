...
untitled_1a62e0cc_1_NeDaePrivateData_create ( NeDaePrivateData * smData ) ;
void untitled_1a62e0cc_1_dae ( NeDae * * dae , const NeModelParameters *
...
untitled_1a62e0cc_1_NeDaePrivateData_create ( smData ) ; * dae =
