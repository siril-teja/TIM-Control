...
rtBTransitions [ ] = { { ( char_T * ) ( & rtB . oad25gyw43 [ 0 ] ) , 0 , 0 ,
541 } , { ( char_T * ) ( & rtDW . mqik13xmg4 [ 0 ] ) , 0 , 0 , 265 } , { (
char_T * ) ( & rtDW . nyeyunwrpn ) , 11 , 0 , 8 } , { ( char_T * ) ( & rtDW .
h5n1lx5ovb ) , 10 , 0 , 1 } , { ( char_T * ) ( & rtDW . ocs23gwlg2 ) , 8 , 0
, 1 } } ; static DataTypeTransitionTable rtBTransTable = { 5U ,
rtBTransitions } ; static DataTypeTransition rtPTransitions [ ] = { { (
char_T * ) ( & rtP . Constant_Value ) , 0 , 0 , 132 } } ; static
