...
void untitled_1a62e0cc_1_resetSimStateVector ( const void * mech , double *
...
} void untitled_1a62e0cc_1_constructStateVector ( const void * mech , const
...
; } void untitled_1a62e0cc_1_extractSolverStateVector ( const void * mech ,
...
untitled_1a62e0cc_1_isVelocityViolation ( const void * mech , const
RuntimeDerivedValuesBundle * rtdv , const int * eqnEnableFlags , const double
* state , const int * modeVector ) { const double * rtdvd = rtdv -> mDoubles
. mValues ; const int * rtdvi = rtdv -> mInts . mValues ; ( void ) mech ; (
void ) rtdvd ; ( void ) rtdvi ; ( void ) eqnEnableFlags ; ( void ) state ; (
void ) modeVector ; return 0 ; } PmfMessageId
untitled_1a62e0cc_1_projectStateSim ( const void * mech , const
...
) error ; } void untitled_1a62e0cc_1_resetModeVector ( const void * mech ,
int * modeVector ) { ( void ) mech ; ( void ) modeVector ; } boolean_T
untitled_1a62e0cc_1_hasJointDisToNormModeChange ( const void * mech , const
...
; return NULL ; } void untitled_1a62e0cc_1_onModeChangedCutJoints ( const
