...
set COMPILER=C:\ProgramData\MATLAB\SupportPackages\R2023a\3P.instrset\mingw_w64.instrset\bin\gcc
                ...
                set LINKFLAGS=-m64 -Wl,--no-undefined -shared -static -L"D:\Application\extern\lib\win64\mingw64" -llibmx -llibmex -llibmat -lm -llibmwlapack -llibmwblas -llibMatlabDataArray -llibMatlabEngine -Wl,"D:\Application/extern/lib/win64/mingw64/mexFunction.def"
                set LINKDEBUGFLAGS=-g
                set NAME_OUTPUT= -o "%OUTDIR%%MEX_NAME%%MEX_EXT%"
set PATH=C:\ProgramData\MATLAB\SupportPackages\R2023a\3P.instrset\mingw_w64.instrset\bin;D:\Application\extern\include\win64;D:\Application\extern\include;D:\Application\simulink\include;D:\Application\lib\win64;%MATLAB_BIN%;%PATH%
...
set LIBPATH=D:\Application\extern\lib\win64;%LIBPATH%

gmake SHELL="cmd" -f HardwareInteg_draft2_sfun.gmk
