...
% systems design (what you'll learn in MECH 412 or MECH 513 can be found by
% typing ``help control''.
...
% Another example; define matrix Q.
Q = [1 2 1;
     2 4 2;
     1 2 3];
...
% return % This stops the code here. If you want to run the code below, just 
      % comment out the ``return" using a `` % ''.
...
hold on
plot(t,-0.5*y,'r-.','Linewidth',line_width);
xlabel('Time (s)','fontsize',font_size,'Interpreter','latex');
ylabel('Output y (units)','fontsize',font_size,'Interpreter','latex');
legend({'$y$','$-y/2$'},'fontsize',20,'Interpreter','latex')
set(gca,'XMinorGrid','off','GridLineStyle','-','FontSize',line_size)
grid on
print -dpng -r720 plot_example
